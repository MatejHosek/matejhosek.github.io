...
Mimo škol při klášterech a kostelech vznikají také univerzity, které stále zůstávají pod dohledem církve, mohou ale studovat i neduchovní. Nejstarší je univerzita v Bologně, dále vznikly např. v Paříži Sorbonna, v Oxfordu, Cambridge nebo Karlova v Praze, dříve označována jako Pražská.

Vyučuje se 5 oborů: filozofie, přírodní vědy, práva, lékařství a bohoslovectví, udělují se tituly bakalář, magistr a doktor. Základem je sedmero svobodných umění. V čele univerzity stojí rektor, v čele jednotlivých fakult děkan.

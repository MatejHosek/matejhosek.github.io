...
1. Zdroj, nějaký oscilátor, který odevzdává svou energii okolnímu prstředí
...
$$y = y_{m}\sin\omega(t-\frac{x}{v}) = y_{m}\sin(\omega(t-t_{0}))$$
...
$$y = y_m \sin (2\pi(\frac{t}{T} - \frac{x}{\lambda}))$$

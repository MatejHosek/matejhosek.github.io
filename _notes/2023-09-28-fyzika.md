...
kde $$k = 9 \cdot 10^9 N \cdot m^2 \cdot C^{-2}$$ je Coulombova konstanta, $$Q_1$$ a $$Q_2$$ náboje těles a $$r$$ vzdálenost mezi tělesy. Všimnout si můžeme podobnosti s Newtonovým gravitačním zákonem, až na konstantu a záměnu hmotností za náboje jsou tyto rovnice stejné.

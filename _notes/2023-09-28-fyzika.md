...
Tání - tepelný pohyb částic se urychlí dostatečně na to, aby došlo k přetrhání vazeb mezi částicemi. Děj probíhá u různých látek při různých teplotách, kterou nazýváme teplotou tání. V tabulkách se uvádí za normálního tlaku, její hodnota lehce závisí na tlaku. U většiny látek s vyšší teplotou roste.

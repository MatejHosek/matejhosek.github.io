...
Vypařování je změna skupenství z kapalného na plynné, probíhá za prakticky každé teploty, za které je látka kapalná. Nejvíce k němu dochází v povrchové vrstvě, při varu ale v celém objemu kapaliny. Dá tedy urychlit zvýšením teploty, zvětšením povrchu či odstraňováním par kapaliny.

Z termodynamického hlediska musíme kapalině dodat skupenské teplo vypařování $$L_{v} = ml_{v}$$
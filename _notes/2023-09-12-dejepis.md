...
3. Křížová výprava
  ...
  - Účast Fridricha Barbarossy, chce se schladit ve vodě, po skoku do vody dostává infarkt a topí se.
4. Křížová výprava
  - Donucení křižáků k vyplenění Cařihratu Janovem a Benátkami. Splacení dluhů za ubytování a stravování před odplutím do Svaté země
5. Dětská křižová výprava

## Gotika

- stavební a umělecký sloh 12. - 15. století
- dokald moci a bohatství církve, složitá symbolika
- zvniká ve Francii, počátky spjaty s budováním katedrály v Saint-Dennis
- typická gotická stavba = katedrála
  ...
  - lomený oblouk na oknech, potrálech
  - křížová žebrová klenba
  - vnitřní opěnrný systém - klenební žebra jsou svedena do přípor předsazených pilířů
